...
namespace ExpenseTracker.Web.Data.Repositories
{
    public interface IExpenseRepository
    {
        ...
        Task<(IEnumerable<Expense> Items, int TotalCount)> SearchAsync(int userId, string? search, int? categoryId, DateTime? fromDate, DateTime? toDate, decimal? minAmount, decimal? maxAmount, string sortBy, string sortOrder, int page, int pageSize);
